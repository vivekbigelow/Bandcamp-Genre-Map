...
let CityResolver = class CityResolver {
    cities() {
        return City_1.City.find();
    }
    city(name) {
        return City_1.City.findOne({ where: name = name });
    }
};
__decorate([
    type_graphql_1.Query(() => [City_1.City]),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], CityResolver.prototype, "cities", null);
__decorate([
    type_graphql_1.Query(() => City_1.City, { nullable: true }),
    __param(0, type_graphql_1.Arg('name')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CityResolver.prototype, "city", null);
